...
var publisher = function () {
    ...
    var displayMessage = function (messageObj) {
        var width = messageObj.username.length + messageObj.message.length + 2;
        ...
        var entireMessage =
            '<div id="holemsg" style="width:' + width +
            '+ ;"><span id="username" style="font-family: Montserrat,sans-serif;font-size: large;color:' + messageObj.userNameColor +
